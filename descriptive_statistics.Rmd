...
apa_table(
  ...
  Housework Distribution can be interpreted as percentages.Gender Role Beliefs and Housework Satisfaction can be interpreted on a 1-5 likert scale."
  , escape = TRUE
  , font_size = "tiny")

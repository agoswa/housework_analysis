...
Participating couples for this study were recruited online and filled out  questionnaires online, too. The participants received a description of the procedure before filling out the questionnaires and were told to fill out the questionnaire by themselves, not with their partners. They were not compensated for participating in this study.  
In this analysis, selected data from a larger study were used that was conducted in 2020. The variables of interest are introduced below. 
...
Participants were asked about several demographic variables such as gender, relationship length, income, work from home status, religion, and race. 

### Housework Distribution  
The scale *Who does what?* used to was developed by @cowan_when_1992. This scale measures the percentages of who performs which chores and household activities through 14 questions. Example questions include "make beds or change bed linens" and "take out garbage, recycling", measured on a five Likert scale (1 = *0 - 20 %* to 5 = *80 - 100 %*). We split this scale into typically male and typically female tasks. The scale was reliable with a Cronbachs Alpha of `r female_tasks_alpha` for female tasks and `r male_tasks_alpha` for male tasks.

### Gender Role Beliefs 
Quantifies the gender role beliefs through the Gender Role Belief Scale (GRBS) developed by Paula S. Kerr and Ronald R. Holden (1996) @kerr_development_1996-1. This self report scale measures gender ideology and beliefs about appropriate behavior for men and women. Example ideologies include "women should not expect men to offer them seats on buses" and "the husband should be regarded as the legal representative of the family in all matters of law", measured on a 1-*Strongly Disagree* to 5-*Strongly Agree* scale. The scale was reliable with a Cronbachs alpha of `r grb_alpha`.
...
### Relationship Length 
Measures the length of the couples' relationship in years. We calculated this value by subtracting the relationship's start date from the date the survey was filled out.
...
Results of the preliminary analysis are shown in Table 1. T-tests showed that age differed significantly between men and women. 

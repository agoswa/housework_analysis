...
husbands <- dat_dyad %>%
  filter(genderE_A == 1)
## making a plot 
## it doesnt work yet because dyadr doesnt install on my version of r so i cant use graphMod

plot<- graphMod(data = husbands,
                x = Cavg_housework_female_A,
                y = Chousework_satisfied_A,
                mod = Cavg_grbs_A
                )
```
...
## using religion and gender as a moderator

...
wife_plot <- ggplot(wives,aes(
  ...
  labs(x = "Housework distribution", y = "Satisfaction", title ="Moderation of wife's housework distribution and satisfaction /nby gender role beliefs",color = "Gender Role Beliefs \n(Wife)")

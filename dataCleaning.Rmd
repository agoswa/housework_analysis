...
dat
```
I just added DyadID and partnum to the table. (Nice code by the way! Love it)
...
We could think about recoding them to 1 - 5 > lets talk about that 
```{r}
...
```{r}
###### data as numerical values, not correct yet
